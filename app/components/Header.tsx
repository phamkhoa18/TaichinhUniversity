...
import {
  ...
  Building2, Users, Trophy, Handshake,
  GraduationCap, BookMarked, Earth, Briefcase,
  Search, ChevronDown, ChevronRight, Menu, X,
  FileText, FlaskConical, Heart, ArrowRight
} from 'lucide-react';
...
const MAIN_NAV: NavItem[] = [
  {
    ...
    groups: [
      ...
      },
      {
        title: 'Hợp tác',
        links: [
          { label: 'Đối tác trong nước', href: '#' },
          { label: 'Đối tác quốc tế', href: '#' },
    ...
    groups: [
      {
        ...
        links: [
          { label: 'Đại học chính quy', href: '#' },
          { label: 'Sau đại học', href: '#' },
          { label: 'Chương trình quốc tế', href: '#' },
      ...
      },
      {
        title: 'Tuyển sinh',
        links: [
          { label: 'Thông tin tuyển sinh', href: '#' },
          { label: 'Điều kiện xét tuyển', href: '#' },
          { label: 'Đăng ký trực tuyến', href: '#' },
        ],
      },
    ],
    promo: {
      title: 'Các Trường & Khối đào tạo',
      desc: 'Trường Đại học Tài chính – Marketing đào tạo đa ngành với chương trình đạt chuẩn quốc tế, mang lại sự phát triển toàn diện về thể chất lẫn trí tuệ.',
  ...
  },
  {
    ...
    groups: [
      {
        title: 'Học tập',
        links: [
          { label: 'Lịch học & Thi', href: '#' },
          { label: 'Hoạt động NCKH', href: '#' },
          { label: 'Thư viện & Tài liệu', href: '#' },
        ],
      },
      {
        title: 'Đời sống',
        links: [
          { label: 'CLB & Đoàn thể', href: '#' },
    ...
    promo: {
      ...
      desc: 'Trải nghiệm môi trường học tập năng động, sáng tạo với hàng trăm câu lạc bộ, sự kiện và hoạt động ngoại khóa phong phú.',
    ...
    groups: [
      {
        ...
        links: [
          { label: 'Lĩnh vực nghiên cứu tập trung', href: '#' },
      ...
      },
      {
        ...
        links: [
          { label: 'Cơ sở vật chất & Phòng thí nghiệm', href: '#' },
          { label: 'Dự án nghiên cứu', href: '#' },
          { label: 'Hội đồng Đạo đức', href: '#' },
          { label: 'Đơn vị nghiên cứu', href: '#' },
        ],
      },
    ],
    promo: {
      title: 'Nghiên cứu tại UFM',
      desc: 'Trường có hệ thống phòng thí nghiệm hiện đại và đội ngũ giảng viên với năng lực nghiên cứu hàng đầu trong lĩnh vực tài chính, kinh tế.',
      cta: 'Tìm hiểu thêm',
      href: '#',
    },
  },
...
/* ── Desktop nav items ── */
const DESKTOP_NAV: { label: string; href?: string; hasChildren?: boolean }[] = [
  { label: 'Giới thiệu', hasChildren: true },
  { label: 'Đào tạo', hasChildren: true },
  { label: 'Sinh viên', hasChildren: true },
  { label: 'Nghiên cứu khoa học', hasChildren: true },
  { label: 'Tin tức', href: '/news' },
  { label: 'Liên hệ', href: '#' },
];
...
export default function Header() {
  ...
  // Lock body scroll when mega overlay is open
  useEffect(() => {
    if (activeMega !== null) {
      document.body.style.overflow = 'hidden';
    } else {
  ...
  const drillItem = drillIdx !== null ? MAIN_NAV[drillIdx] : null;

  // Desktop mega: toggle on click
  ...
  return (
    <header className={`header ${scrolled ? 'header-scrolled' : ''}`}>
      ...
      <div className="header-top-bar">
        <div className="header-top-inner vlu-news-container">
          <div className="header-top-left">
            <a href="tel:02838225048"><Phone size={13} /> (028) 3822 5048</a>
            <a href="mailto:info@taichinh.edu.vn"><Mail size={13} /> info@taichinh.edu.vn</a>
          </div>
        ...
        <div className="vlu-news-container header-main-inner">
          <a href="/" className="logo-area">
            ...
            <div className="logo-text">
              <span className="logo-text-main">Trường Đại học Tài chính - Marketing</span>
              <span className="logo-text-sub">Viện Đào tạo Sau Đại học</span>
            </div>
          </a>
      ...
      {/* ══════════════════════════════════════════
         DESKTOP MEGA MENU — Full-screen overlay (click only)
         ══════════════════════════════════════════ */}
